...
#' @param img.width(/img.height) Image width (/ height) of the trees to be overlayed on the Euclidean space. The unit is "px". Default is 250.
...
phyCMD <- function(obj,color=NULL,label=NULL,img.width=250,img.height=250,size=0.2){
